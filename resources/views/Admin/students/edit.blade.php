    ...
    <form action="{{ route('students.update',$student->id) }}" method="POST">
        ...
        <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold" style="align:center">Student Registration</p>
                </div>
                ...
                <div class="card-body" style="margin-bottom: 5px; padding-bottom: 0px;">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="name"><strong>Name with Initials:&nbsp;</strong></label>
                            <input class="form-control" type="text" id="service_name" placeholder="A.B.C.Perera" name="name" value="{{ $student->user->name }}" required>
                        </div>
                        @error('name')
                    ...
                    {{-- <div class="mb-3"><label class="form-label" for="gender"><strong>Gender:</strong><br></label>
                        <div class="form-group mb-3">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="service_client_payment_validated-1" name="gender" value="female" {{ $student->gender == 'female' ? 'checked' : '' }} required>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="email"><strong>Email:&nbsp;</strong></label>
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$student->user->email}}" required >
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="telephone_no"><strong>Telephone Number:</strong></label>
                            <input class="form-control" type="telno" id="telno" placeholder="07X XXX XXXX" name="phone" maxlength="12" value="{{ $student->phone }}" required>
                        </div>
                        @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="specialization"><strong>"Specialization:</strong><br></label>
                            <input class="form-control" type="text" id="specialization" placeholder="GCE A/L Qualified" name="specialization" value="{{ $student->specialization }}" required>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input class="form-control" type="file" name="file" value="{{ $student->file }}">
                        @error('file')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
