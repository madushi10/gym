...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h3 class="text-dark mb-0">Acadamic staff Details</h3>
        </div>
    </div>
    ...
    <section>
    <div class="container">
    <form action="{{ route('acstaff.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <p class="text-primary m-0 fw-bold" style="align:center">Acadamic staff member Registration</p>
                </div>
                ...
                <div class="card-body" style="margin-bottom: 5px; padding-bottom: 0px;">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="acempnumb"><strong>EMP Number:&nbsp;</strong></label>
                            <input class="form-control" type="text" id="acempnumb" placeholder="EMP/000000" name="acempnumb" maxlength="12" required>
                        </div>
                        @error('acempnumb')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
