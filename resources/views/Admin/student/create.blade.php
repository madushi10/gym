        ...
        <div class="card shadow mb-3">
                ...
                <div class="card-body" style="margin-bottom: 5px; padding-bottom: 0px;">
                    ...
                    <div class="col-sm-15 col-md-4 col-lg-4">
                        <div class="mb-3"><label class="form-label" for="rejnumb"><strong>Student Number:&nbsp;</strong></label>
                            <input class="form-control" type="text" id="rejnumb" placeholder="SC/0000/00000" name="rejnumb" maxlength="15" required>
                        </div>
                        @error('rejnumb')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
